...
import com.google.android.messaging.installer.util.AssetUtil;
...
import com.google.android.messaging.installer.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/com.google.android.messaging.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/com.google.android.messaging.installer/" : BASE_DIR_LEGACY;
    ...
    private static final String[] XPOSED_PROP_FILES = new String[]{
            "/su/xposed/buildysb.prop", // official systemless
            "/system/buildysb.prop",    // classical
    };
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "com.google.android.messaging.installer.fileprovider", new File(info.localFilename));
