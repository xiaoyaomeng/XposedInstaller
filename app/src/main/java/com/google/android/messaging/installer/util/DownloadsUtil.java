...
import com.google.android.messaging.installer.repo.Module;
import com.google.android.messaging.installer.repo.ModuleVersion;
import com.google.android.messaging.installer.repo.ReleaseType;
...
public class DownloadsUtil {
    ...
    private static void showDownloadDialog(final Builder b, final long id) {
        ...
        final DownloadDialog dialog = new DownloadDialog(new MaterialDialog.Builder(context)
                .title(b.mTitle)
                .content(com.google.android.messaging.installer.R.string.download_view_waiting)
                .progress(false, 0, true)
                .progressNumberFormat(context.getString(com.google.android.messaging.installer.R.string.download_progress))
                .canceledOnTouchOutside(false)
                .negativeText(com.google.android.messaging.installer.R.string.download_view_cancel)
                        ...
                        XposedApp.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                Toast.makeText(context,
                                        context.getString(com.google.android.messaging.installer.R.string.download_view_failed, info.reason),
                    ...
                    XposedApp.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (info.totalSize <= 0 || info.status != DownloadManager.STATUS_RUNNING) {
                                dialog.setContent(com.google.android.messaging.installer.R.string.download_view_waiting);
                                dialog.setShowProcess(false);
                            } else {
                                dialog.setContent(com.google.android.messaging.installer.R.string.download_running);
    ...
    public static SyncDownloadInfo downloadSynchronously(String url, File target) {
        ...
        try {
            ...
            if (connection instanceof HttpURLConnection) {
                ...
                if (responseCode == HttpURLConnection.HTTP_NOT_MODIFIED) {
                    ...
                    return new SyncDownloadInfo(SyncDownloadInfo.STATUS_FAILED,
                            mApp.getString(com.google.android.messaging.installer.R.string.repo_download_failed_http,
                                    url, responseCode,
            ...
            return new SyncDownloadInfo(SyncDownloadInfo.STATUS_FAILED,
                    mApp.getString(com.google.android.messaging.installer.R.string.repo_download_failed, url,
                            t.getMessage()));
