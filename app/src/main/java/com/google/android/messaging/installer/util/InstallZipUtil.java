...
import com.google.android.messaging.installer.BuildConfig;
import com.google.android.messaging.installer.installation.FlashCallback;
    ...
    public static String messageForError(int code, Object... args) {
        ...
        switch (code) {
            case FlashCallback.ERROR_TIMEOUT:
                return context.getString(com.google.android.messaging.installer.R.string.flash_error_timeout);

            case FlashCallback.ERROR_SHELL_DIED:
                return context.getString(com.google.android.messaging.installer.R.string.flash_error_shell_died);

            case FlashCallback.ERROR_NO_ROOT_ACCESS:
                return context.getString(com.google.android.messaging.installer.R.string.root_failed);

            case FlashCallback.ERROR_INVALID_ZIP:
                String message = context.getString(com.google.android.messaging.installer.R.string.flash_error_invalid_zip);
                if (args.length > 0) {
                    message += "\n" + args[0];
                }
                return message;
            ...
            case FlashCallback.ERROR_NOT_FLASHABLE_IN_APP:
                return context.getString(com.google.android.messaging.installer.R.string.flash_error_not_flashable_in_app);

            case FlashCallback.ERROR_INSTALLER_NEEDS_UPDATE:
                Resources res = context.getResources();
                return res.getString(com.google.android.messaging.installer.R.string.installer_needs_update, res.getString(com.google.android.messaging.installer.R.string.app_name));

            default:
                return context.getString(com.google.android.messaging.installer.R.string.flash_error_default, code);
        }
    }
