package com.google.android.messaging.installer.util;
...
import com.google.android.messaging.installer.WelcomeActivity;

import com.google.android.messaging.installer.R;
import com.google.android.messaging.installer.WelcomeActivity;
import com.google.android.messaging.installer.XposedApp;
...
public final class NotificationUtil {
    ...
    public static void showNotActivatedNotification(String packageName,
        ...
        String title = sContext.getString(com.google.android.messaging.installer.R.string.module_is_not_activated_yet);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(sContext).setContentTitle(title).setContentText(appName)
                ...
                .setSmallIcon(com.google.android.messaging.installer.R.drawable.ic_notification)
                .setColor(sContext.getResources().getColor(com.google.android.messaging.installer.R.color.colorPrimary));
        ...
        notiStyle.bigText(sContext.getString(
                com.google.android.messaging.installer.R.string.module_is_not_activated_yet_detailed, appName));
        ...
        if (!ModuleUtil.getInstance().getEnabledModules().isEmpty()) {
            builder.addAction(com.google.android.messaging.installer.R.drawable.ic_menu_refresh, sContext.getString(com.google.android.messaging.installer.R.string.activate_and_reboot), pActivateAndReboot);
            builder.addAction(com.google.android.messaging.installer.R.drawable.ic_save, sContext.getString(com.google.android.messaging.installer.R.string.activate_only), pActivate);
        }
    ...
    public static void showModulesUpdatedNotification() {
        ...
        String title = sContext
                .getString(com.google.android.messaging.installer.R.string.xposed_module_updated_notification_title);
        String message = sContext
                .getString(com.google.android.messaging.installer.R.string.xposed_module_updated_notification);
        ...
        builder.addAction(0, sContext.getString(com.google.android.messaging.installer.R.string.reboot), pReboot);
        builder.addAction(0, sContext.getString(com.google.android.messaging.installer.R.string.soft_reboot),
                pSoftReboot);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            */
            ...
            if (intent.hasExtra(EXTRA_ACTIVATE_MODULE)) {
                ...
                Toast.makeText(sContext, com.google.android.messaging.installer.R.string.module_activated, Toast.LENGTH_SHORT).show();
