...
import com.google.android.messaging.installer.repo.RepoParser;
import com.google.android.messaging.installer.repo.Repository;
...
import com.google.android.messaging.installer.repo.RepoDb;
import com.google.android.messaging.installer.repo.RepoParser;
import com.google.android.messaging.installer.repo.RepoParser.RepoParserCallback;
import com.google.android.messaging.installer.repo.Repository;
    ...
    private boolean downloadAndParseFiles(List<String> messages) {
        ...
        for (Entry<Long, Repository> repoEntry : mRepositories.entrySet()) {
            ...
            try {
                ...
                messages.add(sApp.getString(com.google.android.messaging.installer.R.string.repo_load_failed, url, t.getMessage()));
