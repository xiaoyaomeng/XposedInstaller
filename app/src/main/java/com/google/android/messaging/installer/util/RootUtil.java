...
import static com.google.android.messaging.installer.util.InstallZipUtil.triggerError;
...
public class RootUtil {
    ...
    public enum RebootMode {
        NORMAL(com.google.android.messaging.installer.R.string.reboot),
        SOFT(com.google.android.messaging.installer.R.string.soft_reboot),
        RECOVERY(com.google.android.messaging.installer.R.string.reboot_recovery);
        ...
        public static RebootMode fromId(@IdRes int id) {
            switch (id) {
                case com.google.android.messaging.installer.R.id.reboot:
                    return NORMAL;
                case com.google.android.messaging.installer.R.id.soft_reboot:
                    return SOFT;
                case com.google.android.messaging.installer.R.id.reboot_recovery:
                    return RECOVERY;
                default:
    ...
    public static boolean reboot(RebootMode mode, @NonNull Context context) {
        ...
        if (!rootUtil.startShell()) {
            NavUtil.showMessage(context, context.getString(com.google.android.messaging.installer.R.string.root_failed));
            return false;
        }
        ...
        if (!rootUtil.reboot(mode, callback)) {
            ...
            message.append(context.getString(com.google.android.messaging.installer.R.string.reboot_failed));
